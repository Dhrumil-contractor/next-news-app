    ...
    <div>
      <AppBar position="static" className={classes.header}>
        <Toolbar>
          ...
          <p
            className={currentTab(classes, "/feed")}
          ...
          <p className={classes.itemName} onClick={()=>window.location.href("https://www.linkedin.com/in/dhrumil-contractor-668ba4185/")}>LINKEDIN</p>
        </Toolbar>
      </AppBar>
    </div>
  );
